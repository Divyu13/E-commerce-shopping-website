        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light navbar-default bootsnav">
            <div class="container">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="contactus.php"><img src="images/logo1.png" class="logo" alt=""></a>
                </div>
            ...
            <div class="row">
                <div class="col-lg-8 col-sm-12">
                    <div class="contact-form-right">
                        ...
                        <form id="" action="contactus.php" method="post">
                            <div class="row">
                                <div class="col-md-12">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="submit-button text-center">
                                        <input type="submit" class="btn hvr-hover" id="submit" name="b" value="Send Message">
...
if(isset($_POST['b']))
{
      ...
      die('Could not connect:'.mysqli_error($con));
       ...
       $sql="Insert into mail(Username,Email,Subject,Message) values ('$Username','$Email','$Subject','$Message')";
       if(!mysqli_query($con,$sql))
       {
        die('error:'.mysqli_error($con));
       }
       else{
       echo'<h2 align="center" class="style9"><font color="green"><marquee>MESSAGE SENT</marquee></h2>';
       }
}
       //mysqli_close($con);
        ?>
