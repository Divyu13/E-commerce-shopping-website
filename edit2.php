            ...
            <div class="row">
                <div class="col-lg-8 col-sm-12">
                    <div class="contact-form-right">
                      ...
                      include("dbinfo.php");
                      $c=mysqli_connect($server,$username,$password);
                      @mysqli_select_db($c,$database)or die("Unable to select database");
                      ...
                      ?>
                       <form method="post" action="">
                           <table width="584" height="343" border="0">
                               <tr>
                               <td width="202"><p class="style1">Price</p>
                               <td width="366"><label>
                          ...
                          <td colspan="2"><p><a href="message.php" class="style3"></a></p>
                              <p><label>
                                  <input type="submit" name="bu" value="Submit">
                                  </label>
                                  <span class="style3"><label></label></span></p>
                              <p>&nbsp;</p>
                              </tr>
                           </table>
                           <?php
                        ...
                        $sql="UPDATE ".$dbname. " SET price='".$price.
                   "',description= '".$description."' WHERE id='".$id."'";
                        if(mysqli_query($c,$sql)){
                            echo"Records were updated successfully.";
                        }else{
                            echo "ERROR:Could not able to execute $sql.". mysqli_error($c);
                        }
                           }
                           //close connection
                           mysqli_close($c);
