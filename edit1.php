            ...
            <div class="row">
                <div class="col-lg-8 col-sm-12">
                    <div class="contact-form-right">
                        ...
                        $dbl=$_POST['db'];
                        echo'<center><h1>'. $dbl.'</h1></center>';
                        $_SESSION['dbname']=$dbl;
                        $result=mysql_query("SELECT * FROM ".$dbl);
                        echo"<table border=2 bgcolor=lightblue width=100%>";
                        echo"<thead bgcolor=red><tr><td><b>id</b></td><td><b>price</b></td><td><b>description</td></tr></thead>";
                        while($myrow=mysql_fetch_array($result))
                        {
                            echo"<tbody bgcolor=cyan><tr><td>".$myrow["id"]."</td><td>".$myrow["price"]."</td><td>".$myrow["description"]."</td></a>";
                      echo"<td><a href=\"edit2.php?id=".$myrow["id"]."&tb=".$dbl." \">Edit</a>
                          </td>echo "."<td><a href=\"delete.php?id=".$myrow["id"]."&tb=".$dbl."\">Delete</a>
                              </td></tbody>";
                        }
                        echo "</table>";
                        ?>
