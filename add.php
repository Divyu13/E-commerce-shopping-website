            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbar-menu">
					<ul class="nav navbar-nav ml-auto" data-in="fadeInDown" data-out="fadeOutUp">
						...
						<li class="nav-item active"><a class="nav-link" href="add.php">Add Product</a></li>
                    ...
                    <div class="contact-form-right">
                        ...
                        <form action="putimage.php" method="post" enctype="multipart/form-data">
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">Select image file
                                        <input type="file" placeholder="select image file"  class="form-control" name="photo" required data-error="Please select email file.">
                                        <div class="help-block with-errors"></div>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">Price
                                        <input type="text" class="form-control"  name="price" placeholder="Enter price" required data-error="Please enter price">
                                        <div class="help-block with-errors"></div>
                                    </div>
                                </div>
                                 <div class="col-md-12">
                                     <div class="form-group">Size
                                        <select  class="form-control"  name="size" placeholder="size" required data-error="Please select size">
                                            <option>M</option>
                                            <option>L</option>
                                            <option>XL</option>
                                            <option>XXL</option>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">Discription
                                        <textarea class="form-control" name="dis"  placeholder="discribe product" rows="4" data-error="Write your discription" required></textarea>
                                        <div class="help-block with-errors"></div>
                                    </div>
                                    <div class="submit-button text-center">
                                        <input class="btn hvr-hover" id="submit" value="add item" type="submit">
