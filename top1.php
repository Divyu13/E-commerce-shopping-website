...
<html>
    ...
    <body>
        ...
        <div class="container">
            ...
            <br />
            <br />
            <h3 align="center">croptops</a></h3><br/>
            <br/><br/>
            
        <?php
        $query = "SELECT * FROM croptop ORDER BY id ASC";
...
?>
            <div class="col-md-6">
                <form method="post" action="top1.php?action=add&id=<?php echo $row["id"]; ?>">
           ...
           <table class="table table-bordered">
               ...
               ?>
                       <tr>
                            ...
                            <input type="hidden" name="itname[]" value="<?php echo $values["item_name"]; ?>">
         
          <input type="hidden" name="qty[]" value="<?php echo $values["item_quantity"]; ?>">
                           
          <input type="hidden" name="p[]" value="<?php echo $values["item_price"]; ?>">
           <input type="hidden" name="ittotal[]" value="<?echo $values["item_quantity"] * $values["item_price"]?>"                 
